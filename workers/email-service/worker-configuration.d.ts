/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config workers/email-service/wrangler.jsonc workers/email-service/worker-configuration.d.ts` (hash: 39dd9148603ada6145701eb52d9d8e9d)
// Runtime types generated with workerd@1.20260526.1 2026-07-22
interface __BaseEnv_Env {
	EMAIL: SendEmail;
	FROM_ADDRESS: "notifications@tour.report";
	FROM_NAME: "Tour";
}
